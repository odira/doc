...
**
** Created: Tue Nov 1 14:49:56 2011
...
static const char qt_meta_stringdata_CalculatorWidget[] = {
    "CalculatorWidget\0\0valueChanged()\0"
};

const QMetaObject CalculatorWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CalculatorWidget,
      qt_meta_data_CalculatorWidget, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CalculatorWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CalculatorWidget))
