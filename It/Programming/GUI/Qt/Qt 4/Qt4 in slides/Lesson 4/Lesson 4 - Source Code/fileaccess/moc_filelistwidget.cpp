...
**
** Created: Tue Nov 1 15:01:25 2011
...
static const char qt_meta_stringdata_FileListWidget[] = {
    "FileListWidget\0\0addClicked()\0"
    "removeClicked()\0loadClicked()\0"
    "saveClicked()\0"
};

const QMetaObject FileListWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FileListWidget,
      qt_meta_data_FileListWidget, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &FileListWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FileListWidget))
...
int FileListWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: removeClicked(); break;
        case 2: loadClicked(); break;
        case 3: saveClicked(); break;
        default: ;
        }
        _id -= 4;
    }
