...
s.dstEnd="11/4/2012"; // update to the correct Daylight Savings Time end date for the current year.
s.currentYear="2012"; // update to t1e current year (can be done programmatically).
